...
vim.keymap.set('n', '<leader>ba', function() require('dap').toggle_breakpoint() end, { desc = 'Debug: Toggle Breakpoint' })
vim.keymap.set('n', '<leader>Ba', function() require('dap').set_breakpoint(vim.fn.input 'Breakpoint condition: ') end, { desc = 'Debug: Set Breakpoint' })
vim.keymap.set('n', '<leader>bt', function() require('dapui').toggle() end, { desc = 'Debug: Toggle UI' })
vim.keymap.set('n', '<F8>', function() require('dap').terminate() end, { desc = 'Debug: Stop Debugging' })
